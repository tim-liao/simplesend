...
export async function getEmailHistoryQty(id, startTime, endTime) {
...
export async function getUserSendEmailMessageWithoutAttachment(
  id,
  startTime,
  endTime
) {
...
export async function getUserSendEmailWithAttachment(id, startTime, endTime) {
  let [result] = await connectionPool.query(
