document.getElementById("eachpage").addEventListener("click", () => {
  ...
  tour.addStep({
    title: "郵件送達率",
    text: `郵件可能會被對方郵件的伺服器拒絕，或是被歸類到黑名單等等即會被視為未送達，若對方伺服器回傳成功即視為成功。`,
    attachTo: {
  ...
  tour.addStep({
    title: "累積使用寄件數量",
    text: `您創建帳號後，在本服務中所累積使用過的寄出郵件數量。`,
    attachTo: {
  ...
  tour.addStep({
    title: "使用設備佔比",
    text: `紀錄您所有有使用追蹤連結點擊功能的使用設備數量及佔比。（部分設備僅記錄相關作業系統）`,
    attachTo: {
  ...
  tour.addStep({
    title: "歷史寄件紀錄",
    text: `在上方欄位選擇起始日期以及結束日期，即可查看該時間區間中，每天的寄件數量。`,
    attachTo: {
